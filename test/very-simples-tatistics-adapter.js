...
var adapter = require('../src/very-simple-statistics-adapter');

describe('linear arbitrary precision with very-simple-statistics', function() {
  ...
  describe('operations', function() {
    ...
    it('should have a div method', function() {
      new Decimal(0.3).div(new Decimal(0.2)).valueOf().should.be.exactly(0.3 * (1 / 0.2));
    });
  });
